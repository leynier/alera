...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiGitGitBranchDefaultBranch({required String path});
  ...
  Future<void> crateApiGitGitBranchResetBranchToRef({
    required String path,
    required String branch,
  ...
  Future<Uint8List> crateApiWorkflowApprovalSignWorkflowDecision({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(path, serializer);
          sse_encode_String(branch, serializer);
          sse_encode_opt_String(expectedHead, serializer);
          sse_encode_opt_String(expectedOid, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 8,
        ...
        argValues: [path, branch, expectedHead, expectedOid],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateApiGitGitBranchCreateAndCheckoutBranchConstMeta =>
      const TaskConstMeta(
        ...
        argNames: ["path", "branch", "expectedHead", "expectedOid"],
      );
  ...
  Future<String> crateApiGitGitBranchDefaultBranch({required String path}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiGitGitBranchDefaultBranchConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiGitGitBranchDefaultBranchConstMeta =>
      const TaskConstMeta(debugName: "default_branch", argNames: ["path"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(path, serializer);
          sse_encode_String(ancestorRef, serializer);
          sse_encode_String(descendantRef, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 47,
        ...
        constMeta: kCrateApiGitIsAncestorConstMeta,
        argValues: [path, ancestorRef, descendantRef],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiGitIsAncestorConstMeta => const TaskConstMeta(
    debugName: "is_ancestor",
    argNames: ["path", "ancestorRef", "descendantRef"],
  );
  ...
  Future<KeepAliveStatusDto> crateApiKeepAliveKeepAliveStatus() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_keep_alive_status_dto,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiKeepAliveKeepAliveStatusConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiKeepAliveKeepAliveStatusConstMeta =>
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(path, serializer);
          sse_encode_String(branch, serializer);
          sse_encode_String(targetRef, serializer);
          sse_encode_opt_String(expectedOid, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
        ...
        constMeta: kCrateApiGitGitBranchResetBranchToRefConstMeta,
        argValues: [path, branch, targetRef, expectedOid],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiGitGitBranchResetBranchToRefConstMeta =>
      const TaskConstMeta(
        debugName: "reset_branch_to_ref",
        argNames: ["path", "branch", "targetRef", "expectedOid"],
      );
  ...
  Future<KeepAliveStatusDto> crateApiKeepAliveSetKeepAlive({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiKeepAliveSetKeepAliveConstMeta,
        argValues: [enabled],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiKeepAliveSetKeepAliveConstMeta =>
      const TaskConstMeta(debugName: "set_keep_alive", argNames: ["enabled"]);
  ...
  Future<Uint8List> crateApiWorkflowApprovalSignWorkflowDecision({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(runtimeDir, serializer);
          sse_encode_String(statementJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 81,
        ...
        constMeta: kCrateApiWorkflowApprovalSignWorkflowDecisionConstMeta,
        argValues: [runtimeDir, statementJson],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiWorkflowApprovalSignWorkflowDecisionConstMeta =>
      const TaskConstMeta(
        debugName: "sign_workflow_decision",
        argNames: ["runtimeDir", "statementJson"],
      );
  ...
  KeepAliveStatusDto dco_decode_keep_alive_status_dto(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return KeepAliveStatusDto(
      active: dco_decode_bool(arr[0]),
      system: dco_decode_bool(arr[1]),
      display: dco_decode_bool(arr[2]),

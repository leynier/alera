...
| 115 | `b617e61916835cf81d9fea6c4dd13c69d0a06d9f` | 2026-08-07 | fix: align cursor hooks with the documented contract (#369) | in_progress | Replaying Cursor per-session plugin delivery, launch-time runtime integration, event normalization, and approval-safe hook behavior; GPUI will consume the corrected runtime status without a separate visual surface. |

...
| 124 | `bafbe063ba93ec887cf95cd26f83a5bee423e7ee` | 2026-08-08 | feat: add codex desktop session contracts | in_progress | Replaying Codex desktop session contracts, persisted per-tab configuration, resume/recovery controls, composer drafts, and session actions; GPUI will add equivalent thread controls to its native Codex surface. |

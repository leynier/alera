...
| 114 | `ae11c13f2664cfa209b70bed2632a56c96c7199b` | 2026-08-07 | fix: align antigravity hooks with the documented contract (#368) | in_progress | Replaying the Antigravity hook contract, runtime script responses, bundle deduplication, enabled flag, timeout, and Windows command quoting; no separate GPUI surface change is expected because GPUI consumes the runtime hook status. |

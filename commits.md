...
| 116 | `1af236b9eeccfe269010d6850f677dbd60e48b89` | 2026-08-07 | fix: deliver the initial prompt to every agent, not only codex (#370) | in_progress | Replaying launch-time prompt delivery for every agent adapter, including Amp stdin scripts and adapter-specific CLI forms; GPUI already delegates agent launches to the runtime host. |

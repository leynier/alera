...
| 122 | `17d540d1e9d1a8642e10a004b093aefce3023e32` | 2026-08-08 | feat: add durable codex thread state management | in_progress | Replaying durable Codex thread/session state, history projection, lifecycle cleanup, turn policy, and event routing; GPUI will be rechecked against the updated runtime protocol and preserve its native Codex surface. |

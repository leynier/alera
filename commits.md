...
| 103 | `354e5a9dd7be46fe7ddbb1d7ff43743c6797f829` | 2026-08-06 | feat: add opencode models and quota tracking | merged | Cherry-picked the OpenCode quota/model host implementation. GPUI now enables OpenCode in default quota settings, orders Go/Zen accounts, uses the OpenCode icon/labels/pin keys, renders amount-based USD readings without percentage bars, marks estimated quality, and keeps the provider available in settings. Targeted GPUI and CLI checks pass. |
| 104 | `43b2d03c453b66376201d2116b9f51f652b372af` | 2026-08-06 | style: match hosted dart formatter | in_progress | Replaying source-only Dart formatter output; no GPUI code change is expected. |

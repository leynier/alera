...
| 127 | `2c8e6392a2e5a32916702783463a1054cbde666c` | 2026-08-09 | feat: add codex mobile runtime state | in_progress | Replaying mobile Codex runtime/session state, preferences, bounded workspace files, and draft persistence; no separate GPUI code change is expected beyond shared runtime compatibility. |

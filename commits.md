...
| 83 | `9f5d9459794892829c7168b7c620347e85638911` | 2026-08-03 | feat: expose agent canvas skill installation | merged | Cherry-picked the Agent Canvas skill installer and settings/search/source command updates. Added the Agent Canvas installer row and runner selector to GPUI Agents settings, included the skill in all-skills installation with `--yes`, and made command previews horizontally scrollable for single-line parity. |
| 84 | `84129124a38b86a8a184c9cc29cd9f6f91d1c049` | 2026-08-03 | Merge pull request #357 from leynier/feat/agent-canvas-skill-install | in_progress | Replaying the source merge after the Agent Canvas installer commit; checking for merge-result-only changes. |

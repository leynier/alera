...
- Rename terminal and non-terminal tabs from the tab action sheet. Non-terminal content remains unavailable on mobile, but its runtime-owned title stays synchronized with desktop.

...
///
/// Mirrors the desktop `WorkspaceAgentComment` so mixed file+diff queues build
/// the same prompt bytes on either surface.
...
/// Title-case Source Control area for prompt/location labels, matching
/// desktop `GitChangeArea.label`.
String workspaceAgentCommentAreaLabel(String area) {
  return switch (area) {
    'staged' => 'Staged',
    'unstaged' => 'Unstaged',
    'untracked' => 'Untracked',

...
///
/// Copied from the desktop `pull_request_agent_prompts.dart`. The prompt may
/// reach a shell as a launch argument, so it avoids backticks and other
/// characters a shell would expand. It names no files, SHAs, or commit
/// messages; the agent inspects the workspace itself.

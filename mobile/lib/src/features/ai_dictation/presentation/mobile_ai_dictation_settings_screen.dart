...
class _MobileAiDictationSettingsScreenState
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ListView(padding: AleraTokens.pagePadding, children: <Widget>[
          SwitchListTile(
              value: _settings.enabled,
              title: const Text('Enable AI Dictation'),
              subtitle:
                  const Text('Add microphone controls to mobile composers.'),
          ...
          TextField(
              ...
              onChanged: (value) =>
                  _save(_settings.copyWith(providerModel: value))),
          const SizedBox(height: AleraTokens.spaceXl),
          const Text(

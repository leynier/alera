...
void main() {
  test('feature detects prompt image uploads and sends ordered chunks', () async {
      ...
      socket.listen((raw) {
        ...
        final payload = switch (type) {
          'mobile.hello' => <String, Object?>{
            'runtimeCapabilities': <String>[mobilePromptImageUploadCapability],
          },
          ...
          'mobile.promptImage.complete' => <String, Object?>{
            'path':
                '/runtime/prompt-images/00000000-0000-4000-8000-000000000001.png',
          },
          _ => <String, Object?>{},
        };
        socket.add(

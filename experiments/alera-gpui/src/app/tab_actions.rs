...
impl AleraApp {
    pub(super) fn should_keep_git_preview(&mut self, key: String) -> bool {
        ...
        if keep {
            self.git_preview_last_key = None;
            self.git_preview_last_at = None;
        } else {
            self.git_preview_last_key = Some(key);
            self.git_preview_last_at = Some(now);
        }
        keep
    }
    ...
    pub(super) fn open_git_diff_tab(
        ...
        self.open_git_diff_tab_with_preview(relative_path, area, false, cx);
    }

    pub(super) fn open_git_diff_preview_tab(
        &mut self,
        relative_path: Option<String>,
        area: Option<String>,
        permanent: bool,
        ...
        self.open_git_diff_tab_with_preview(relative_path, area, !permanent, cx);
    }

    fn open_git_diff_tab_with_preview(
        &mut self,
        relative_path: Option<String>,
        area: Option<String>,
        preview: bool,
        ...
        let tab_id = replacement
            ...
            .unwrap_or_else(|| format!("gpui-git-diff-{}", uuid::Uuid::new_v4()));

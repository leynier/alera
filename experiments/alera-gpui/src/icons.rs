...
impl AleraIcon {
    fn codicon_asset(self) -> Option<&'static str> {
        match self {
            ...
            Self::ArrowDropDown => Some("google-material-icons/arrow-drop-down.svg"),

...
use crate::terminal_host::ai_assist_capabilities::{
    RUNTIME_HOST_AI_ASSIST_AGENT_TITLE_CAPABILITY, RUNTIME_HOST_AI_ASSIST_OPENCODE_GO_CAPABILITY,
...
use crate::terminal_host::protocol::{
    ...
    RUNTIME_HOST_BOOTSTRAP_CAPABILITY, RUNTIME_HOST_CAPABILITY, RUNTIME_HOST_CLOUD_PUSH_CAPABILITY,
    RUNTIME_HOST_LIFECYCLE_CAPABILITY, RUNTIME_HOST_LINKED_ISSUES_CAPABILITY,
    ...
    RUNTIME_HOST_ORCHESTRATION_BOARD_CAPABILITY, RUNTIME_HOST_ORCHESTRATION_CAPABILITY,
    RUNTIME_HOST_ORCHESTRATION_TERMINAL_INSPECTION_CAPABILITY,
    RUNTIME_HOST_ORCHESTRATION_WAIT_CAPABILITY, RUNTIME_HOST_PROJECT_HOSTS_CAPABILITY,
    RUNTIME_HOST_PULL_REQUEST_WATCH_CAPABILITY,
    RUNTIME_HOST_PULL_REQUEST_WATCH_EXECUTION_CAPABILITY,
    RUNTIME_HOST_REMOTE_AGENT_HOOK_RELAY_CAPABILITY, RUNTIME_HOST_REMOTE_GIT_CAPABILITY,
    RUNTIME_HOST_REMOTE_HOST_LINK_CAPABILITY, RUNTIME_HOST_REMOTE_PROCESS_CAPABILITY,
    RUNTIME_HOST_REMOTE_SATELLITE_CAPABILITY, RUNTIME_HOST_REMOTE_SSH_WORKSPACES_CAPABILITY,
    RUNTIME_HOST_RESOURCE_MONITOR_CAPABILITY, RUNTIME_HOST_RESTART_CAPABILITY,
    RUNTIME_HOST_RUN_POLICY_CAPABILITY, RUNTIME_HOST_TERMINAL_DEFERRED_INPUT_CAPABILITY,
    RUNTIME_HOST_TERMINAL_DRIVER_CAPABILITY, RUNTIME_HOST_TERMINAL_PULSE_CAPABILITY,
    RUNTIME_HOST_TERMINAL_RESTART_CAPABILITY, RUNTIME_HOST_WORKFLOW_CATALOG_CAPABILITY,
    RUNTIME_HOST_WORKFLOW_EXPORT_CAPABILITY, RUNTIME_HOST_WORKFLOW_INTEGRATIONS_CAPABILITY,
    RUNTIME_HOST_WORKFLOW_LIFECYCLE_CAPABILITY, RUNTIME_HOST_WORKFLOW_PLANS_CAPABILITY,
    RUNTIME_HOST_WORKFLOW_WORKSPACES_CAPABILITY, RUNTIME_HOST_WORKSPACE_ARCHIVE_CAPABILITY,
    RUNTIME_HOST_WORKSPACE_SECTIONS_CAPABILITY, RUNTIME_HOST_WORKSPACE_SLEEP_STATE_CAPABILITY,
};
...
pub fn write_control_file(
    ...
    let body = json!({
        ...
        "runtimeCapabilities": [
            ...
            RUNTIME_HOST_REMOTE_HOST_LINK_CAPABILITY,
            RUNTIME_HOST_REMOTE_SATELLITE_CAPABILITY,
            RUNTIME_HOST_REMOTE_GIT_CAPABILITY,
            RUNTIME_HOST_REMOTE_PROCESS_CAPABILITY,
            RUNTIME_HOST_REMOTE_AGENT_HOOK_RELAY_CAPABILITY,
            RUNTIME_HOST_PROJECT_HOSTS_CAPABILITY,
            ...
            RUNTIME_HOST_WORKSPACE_SLEEP_STATE_CAPABILITY,

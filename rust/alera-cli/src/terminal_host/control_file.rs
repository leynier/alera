...
use crate::terminal_host::protocol::{
    ...
    RUNTIME_HOST_WORKFLOW_PLANS_CAPABILITY, RUNTIME_HOST_WORKFLOW_WORKSPACES_CAPABILITY,
    RUNTIME_HOST_WORKSPACE_ARCHIVE_CAPABILITY, RUNTIME_HOST_WORKSPACE_SECTIONS_CAPABILITY,

...
impl ServerActor {
    pub(super) fn start_ai_text_speech_message(
        &mut self,
        client_id: u64,
        request_id: i64,
        payload: &Value,
...
mod tests {
    ...
    use alera_core::runtime::{RuntimeAiTextGenerationSettings, RuntimeAiTextPromptSettings};

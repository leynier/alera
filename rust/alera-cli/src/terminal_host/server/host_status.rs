...
use crate::terminal_host::protocol::{
    ...
    RUNTIME_HOST_AI_TEXT_WORKSPACE_IDENTITY_CAPABILITY, RUNTIME_HOST_BOOTSTRAP_CAPABILITY,
    ...
    RUNTIME_HOST_CODEX_RESET_CREDITS_CAPABILITY, RUNTIME_HOST_COMPUTER_USE_CAPABILITY,

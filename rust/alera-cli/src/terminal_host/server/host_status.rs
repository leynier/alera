...
use crate::terminal_host::protocol::{
    ...
    RUNTIME_HOST_AUTOMATIONS_CAPABILITY, RUNTIME_HOST_BOOTSTRAP_CAPABILITY,
    RUNTIME_HOST_CAPABILITY, RUNTIME_HOST_CLOUD_PUSH_CAPABILITY,
    RUNTIME_HOST_CODEX_RESET_CREDITS_CAPABILITY, RUNTIME_HOST_DIAGNOSTICS_LOGS_CAPABILITY,
    ...
    RUNTIME_HOST_REMOTE_HOST_LINK_CAPABILITY, RUNTIME_HOST_REMOTE_SATELLITE_CAPABILITY,
    RUNTIME_HOST_REMOTE_SSH_WORKSPACES_CAPABILITY, RUNTIME_HOST_RESOURCE_MONITOR_CAPABILITY,

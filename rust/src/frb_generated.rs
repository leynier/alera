...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -574137568;
...
fn wire__crate__api__git__git_branch__create_and_checkout_branch_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_path = <String>::sse_decode(&mut deserializer);
            let api_branch = <String>::sse_decode(&mut deserializer);
            let api_expected_head = <Option<String>>::sse_decode(&mut deserializer);
            let api_expected_oid = <Option<String>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, crate::api::git::GitError>((move || {
...
fn wire__crate__api__git__git_branch__default_branch_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, crate::api::git::GitError>((move || {
                    let output_ok = crate::api::git::git_branch::default_branch(api_path)?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__git__git_branch__reset_branch_to_ref_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "reset_branch_to_ref",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_path = <String>::sse_decode(&mut deserializer);
            let api_branch = <String>::sse_decode(&mut deserializer);
            let api_target_ref = <String>::sse_decode(&mut deserializer);
            let api_expected_oid = <Option<String>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, crate::api::git::GitError>((move || {
                    let output_ok = crate::api::git::git_branch::reset_branch_to_ref(
                        api_path,
                        api_branch,
                        api_target_ref,
                        api_expected_oid,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        13 => wire__crate__api__git__git_branch__default_branch_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        15 => wire__crate__api__workspace_files__delete_workspace_entry_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        22 => wire__crate__api__git_diff_blob__git_diff_blob_bytes_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__git__git_discard_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__git__git_discard_area_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__git_explorer_status__git_explorer_status_snapshot_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__git__git_fetch_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__git__git_hosted_review__git_fetch_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        28 => wire__crate__api__git__git_history_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__git__git_list_stashes_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__git__git_hosted_review__git_persist_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__git__git_pull_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__git__git_push_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__git__git_range_context_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__reading_diff__git_reading_diff_patch_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        35 => wire__crate__api__git__git_hosted_review__git_release_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        81 => wire__crate__api__agent_hooks__start_agent_hook_receiver_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        82 => wire__crate__api__workspace_files__start_source_control_watcher_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        83 => wire__crate__api__workspace_files__start_workspace_explorer_watcher_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        84 => wire__crate__api__workspace_files__start_workspace_quick_open_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        85 => wire__crate__api__agent_hooks__stop_agent_hook_receiver_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        86 => wire__crate__api__workspace_files__stop_source_control_watcher_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        87 => wire__crate__api__workspace_files__stop_workspace_explorer_watcher_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        88 => wire__crate__api__workspace_files__stop_workspace_quick_open_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        89 => wire__crate__api__ai_dictation__transcribe_whisper_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        90 => wire__crate__api__workspace_files__update_workspace_explorer_watcher_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        91 => wire__crate__api__agent_hooks__watch_agent_hook_event_batches_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        92 => wire__crate__api__workspace_files__watch_source_control_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        93 => wire__crate__api__workspace_files__watch_workspace_explorer_events_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        94 => wire__crate__api__workspace_files__write_workspace_editor_text_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        95 => wire__crate__api__workspace_files__write_workspace_text_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,

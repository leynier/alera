...
fn wire__crate__api__git__create_and_checkout_branch_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "create_and_checkout_branch",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__workspace_files__create_workspace_directory_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__workspace_files__create_workspace_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        14 => wire__crate__api__git__git_commit_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__git__git_commit_amend_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__git__git_commit_compare_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__git__git_commit_diff_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__git__git_diff_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__git__git_diff_all_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__git_diff_blob__git_diff_blob_bytes_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__git__git_discard_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__git__git_discard_area_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__git_explorer_status__git_explorer_status_snapshot_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__git__git_fetch_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__git__git_hosted_review__git_fetch_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__git__git_history_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__git__git_list_stashes_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__git__git_hosted_review__git_persist_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        31 => wire__crate__api__git__git_range_context_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__reading_diff__git_reading_diff_patch_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        33 => wire__crate__api__git__git_hosted_review__git_release_hosted_review_range_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__git__git_repository_state_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__git__git_stage_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__git__git_stage_area_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__git__git_stash_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__git__git_stash_pop_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__git__git_status_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__git__git_status_for_path_impl(port, ptr, rust_vec_len, data_len),
        41 => wire__crate__api__git__git_submodule_status_impl(port, ptr, rust_vec_len, data_len),
        42 => wire__crate__api__git__git_unstage_impl(port, ptr, rust_vec_len, data_len),
        43 => wire__crate__api__git__git_unstage_area_impl(port, ptr, rust_vec_len, data_len),
        ...
        51 => wire__crate__api__git__list_remotes_impl(port, ptr, rust_vec_len, data_len),
        52 => wire__crate__api__workspace_files__list_workspace_children_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        53 => wire__crate__api__git__list_worktrees_impl(port, ptr, rust_vec_len, data_len),
        54 => wire__crate__api__reading_diff__merge_reading_diff_chunks_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        55 => wire__crate__api__workspace_files__move_workspace_entry_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        56 => wire__crate__api__reading_diff__prepare_reading_diff_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        57 => wire__crate__api__workspace_search__preview_workspace_replace_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        58 => wire__crate__api__workspace_search__preview_workspace_replace_cancelable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        60 => wire__crate__api__process__process_kill_impl(port, ptr, rust_vec_len, data_len),
        61 => wire__crate__api__process__process_run_impl(port, ptr, rust_vec_len, data_len),
        62 => wire__crate__api__process__process_start_impl(port, ptr, rust_vec_len, data_len),
        63 => {
            wire__crate__api__process__process_write_stdin_impl(port, ptr, rust_vec_len, data_len)
        }
        64 => wire__crate__api__workspace_files__project_workspace_explorer_tree_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        65 => wire__crate__api__workspace_files__read_workspace_editor_text_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        66 => wire__crate__api__workspace_files__read_workspace_text_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        70 => wire__crate__api__merman_viewer__render_merman_workspace_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        71 => wire__crate__api__workspace_search__replace_workspace_matches_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        72 => wire__crate__api__clipboard__save_clipboard_image_as_temp_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        73 => wire__crate__api__workspace_search__search_workspace_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        74 => wire__crate__api__workspace_search__search_workspace_cancelable_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        75 => wire__crate__api__workspace_files__search_workspace_quick_open_session_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        76 => wire__crate__api__agent_hooks__set_agent_hook_enabled_agents_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        77 => wire__crate__api__keep_alive__set_keep_alive_impl(port, ptr, rust_vec_len, data_len),

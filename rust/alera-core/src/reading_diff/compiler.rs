...
use super::imports::{hide_import_only_sections, mandatory_import_mask};
use super::moves::{
    normalize_automatic_move_mask, validate_cross_chunk_move_retention, validate_move_symmetry,
};
...
pub fn compile_with_source(
    ...
    normalize_automatic_move_mask(&lines, &mut hidden);

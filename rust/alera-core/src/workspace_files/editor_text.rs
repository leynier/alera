//! Editor buffer codec shared by the desktop bridge and the runtime host.
//!
//! The editor shows tabs expanded to columns; on save, lines the user did not
//! touch keep their original raw bytes so a file is never re-indented as a
//! side effect of editing another line.

pub fn encode_workspace_editor_text_for_save(
...
pub fn expand_workspace_editor_tabs(text: &str, tab_size: i32) -> String {

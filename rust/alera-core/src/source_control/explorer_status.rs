//! Explorer decorations: one status per changed path and every ancestor
//! directory, so the tree can badge folders that contain changes.
...
use super::{git_status, GitChangeStatus, GitError, GitErrorKind};

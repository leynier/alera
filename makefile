...
.PHONY: help init-submodules update-submodules frb-generate rust-test cli-build cli-help runtime-dev-build host-debug app-debug app-profile app-debug-bundled-cli app-debug-runtime-dev debug-processes host-stop perf-linux perf-macos-resources

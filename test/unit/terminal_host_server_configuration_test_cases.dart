...
void _registerTerminalHostServerConfigurationTests() {
  test(
    'applies configure requests to lifecycle and output buffers',
    () async {
      ...
      final created = await client.request('createOrAttach', <String, Object?>{
        ...
        'launch': const TerminalHostLaunch(
          ...
          arguments: <String>[
            '-c',
            'printf ready; IFS= read -r _; printf abcdefghijklmno',
          ],
      ...
      expect(
        await client.outputContaining('trimmed-output', 'ready'),
        contains('ready'),
      );
      await client.request('write', <String, Object?>{
        'sessionId': 'trimmed-output',
        'dataBase64': encodeTerminalHostBytes(utf8.encode('go\r')),
      });
      ...
      expect(
        utf8.decode(
          decodeTerminalHostBytes(attached.payload['snapshotBase64']),
        ),
        'hijklmno',
      );
      ...
      final reattached = await client.request(
        'createOrAttach',
        <String, Object?>{
          'sessionId': 'trimmed-output',
          'workspaceId': 'workspace-1',
    ...
    () async {
      ...
      final created = await client.request('createOrAttach', <String, Object?>{
        ...
        'launch': const TerminalHostLaunch(
          ...
          arguments: <String>[
            '-c',
            r"printf ready; IFS= read -r _; head -c 1050000 /dev/zero | tr '\0' x",
          ],
          environment: <String, String>{},
        ).toJson(),
      });
      expect(created.payload['created'], isTrue);
      expect(
        await client.outputContaining('large-output', 'ready'),
        contains('ready'),
      );
      await client.request('write', <String, Object?>{
        'sessionId': 'large-output',

...
part 'workbench_controller_handoff_test_cases.dart';
...
part 'workbench_controller_navigation_history_test_cases.dart';
...
void main() {
  group('WorkbenchController', () {
    ...
    _registerWorkbenchControllerHandoffTests();
    ...
    _registerWorkbenchControllerNavigationHistoryTests();

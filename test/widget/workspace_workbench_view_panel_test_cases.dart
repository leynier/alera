...
void _registerWorkspacePanelViewTests() {
  testWidgets('mounts only the selected surface without a tab strip', (
    tester,
  ) async {
    final tabs = [
    ...
    Future<void> pump({required String id}) => _pumpWorkbenchView(
      tester,
      tabs: tabs,
      layout: layout,

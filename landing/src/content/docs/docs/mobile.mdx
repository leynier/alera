...
The companion is a separate Flutter app targeting Android (an arm64 APK; see [Install](/docs/install)). Pairing starts from **Settings → Mobile Devices** on the desktop, or through `alera mobile ...`.

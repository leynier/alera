...
The companion is a separate Flutter app targeting 64-bit Android phones (see [Install](/docs/install)). Pairing starts from **Settings → Mobile Devices** on the desktop, or through `alera mobile ...`.

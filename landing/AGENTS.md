...
- Use the existing landing structure before adding new patterns:
  ...
  - Product screenshots and the marketing demo video live in `public/media/` and are mirrored in `../assets/product/` for the repository README. Prefer WebP stills and a short muted MP4. Desktop stills come from the shipping app; mobile stills are UI-faithful companion screens. Do not overclaim live-device capture.
